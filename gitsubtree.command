...
readonly LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS="gl-kebab-android-runner-scripts"
...
readonly GL_KEBAB_ANDROID_RUNNER_SCRIPTS="${GIT_REMOTE_URL_GL_ANDROID_RUNNER_SCRIPTS}/${LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS}"
...
unset_git_remote(){
    echo "Removing ${LOCAL_NAME_GL_KEBAB_R}, ${LOCAL_NAME_GL_KEBAB_SUBJECT}, ${LOCAL_NAME_LACUNA_V2}, ${LOCAL_NAME_ANDROID_RUNNER}, ${LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS}"
    git remote remove $LOCAL_NAME_GL_KEBAB_R
    git remote remove $LOCAL_NAME_GL_KEBAB_SUBJECT
    git remote remove $LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS
    git remote remove $LOCAL_NAME_LACUNA_V2
    git remote remove $LOCAL_NAME_ANDROID_RUNNER
}

set_git_remote(){
    echo "seting remote ${LOCAL_NAME_GL_KEBAB_R}, ${LOCAL_NAME_GL_KEBAB_SUBJECT}, ${LOCAL_NAME_LACUNA_V2}, ${LOCAL_NAME_ANDROID_RUNNER}, ${LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS}"
    ...
    git remote add $LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS $GIT_REMOTE_URL_GL_ANDROID_RUNNER_SCRIPTS
...
pull_subtrees(){
    ...
    git subtree add --prefix=$GIT_REMOTE_URL_GL_ANDROID_RUNNER_SCRIPTS --squash $LOCAL_NAME_GL_ANDROID_RUNNER_SCRIPTS master
